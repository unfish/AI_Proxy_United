...
[ApiProvider("ReadBook")]
public class ApiReadBookProvider : ApiProviderBase
{
    protected IApiFactory _apiFactory;
    public ApiReadBookProvider(ConfigHelper configHelper, IServiceProvider serviceProvider, IApiFactory apiFactory):base(configHelper,serviceProvider)
    {
    ...
    public override async IAsyncEnumerable<Result> SendMessageStream(ApiChatInputIntern input)
    {
        ...
        var gemini = serviceProvider.GetRequiredService<ApiGoogleProvider>();
