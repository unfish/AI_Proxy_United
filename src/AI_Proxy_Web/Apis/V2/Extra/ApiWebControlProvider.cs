...
/// <summary>
/// 用获取浏览器源码并操作元素节点的方式而不是截屏的方式操作虚拟浏览器执行任务
/// </summary>
[ApiProvider("WebControl")]
public class ApiWebControlProvider : ApiProviderBase
{
    protected IApiFactory _apiFactory;
    public ApiWebControlProvider(ConfigHelper configHelper, IServiceProvider serviceProvider, IApiFactory apiFactory):base(configHelper,serviceProvider)
    {
    ...
    {
        int modelId = int.Parse(_modelName);
