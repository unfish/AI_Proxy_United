...
项目中附带了一个基于Tauri 2.0的本地客户端程序源码，基于本项目的Claude Agent接口，利用Computer use功能，实现本地电脑的完全AI控制，根据你提出的任务，自行分解任务步骤，查看本地电脑的可用软件，并一步一步自动完成任务。项目说明参考[clients/Automation/README.md](clients/Automation/README.md)
